...
urlpatterns = [
    ...
    path("flight/edit/<uuid:pk>/", EditFlightScheduleView.as_view(), name="flight-edit"),
    path("flights/depature/time/range/<departure>/<arrival>/", TimeIntervalListFlightView.as_view(), name="sarch-range"),
    path("flights/depature/<icao>", DepartureFlightsView.as_view(), name="sarch-departure"),
